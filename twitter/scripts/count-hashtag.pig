...
filter_hashtag_mention = FILTER entities BY (NOT IsEmpty(tweet_entities#'hashtags'));
hashtag_mention = FOREACH filter_hashtag_mention GENERATE FLATTEN((bag{})tweet_entities#'hashtags') as (hash_tags:[]);
